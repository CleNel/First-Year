...
int main()
{
  ...
  string name;
	...
	cin >> hours >> hourly_rate >> tax_credit;// etc...
  getline(cin,name);
  ...
  cout << "Hourly rate" << setw(19) << hourly_rate << endl;
  cout << "Gross wage" << setw(20) << gross_pay << endl;
  cout << "Tax @ 20%" << setw(21) << tax << endl;
  cout << "PRSI @ 2.5%" << setw(19) << prsi << endl;
  cout << "------------------------------" << endl;
  cout << "Net pay" << setw(23) << net_pay << endl;
